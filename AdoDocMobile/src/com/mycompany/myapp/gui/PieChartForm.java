...
import com.mycompany.myapp.services.StatService;
import java.util.ArrayList;
import java.util.List;
import java.util.Random;
import java.util.concurrent.ThreadLocalRandom;

public class PieChartForm extends BaseForm {

    Form current;
    ArrayList<Stat> stats;

    public PieChartForm(Resources res, Form previous) {

        this.stats = StatService.getInstance().getStats();
